...
def main(args: argparse.Namespace) -> None:
    ...
    with open(args.test_path, "r") as source:
        for line in source:
            ...
            lattice = (lg @ cg_fst @ pred_pron).project(True)
    ...
    print_table.add_row(["Pron Match", rule_m_pred_m, rule_nm_pred_m])
    print_table.add_row(["Pron Not Match", rule_m_pred_nm, rule_nm_pred_nm])
    print(print_table)
