...
def main() -> None:
    ...
    unique_iso_codes = set()  # To store unique ISO 639-2 codes
    unique_scripts = set()  # To store unique scripts
    ...
    # Calculate the number of "Broad" and "Narrow" files for unique iso codes and dialects
    table = pd.read_csv(
